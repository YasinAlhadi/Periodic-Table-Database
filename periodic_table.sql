...
--
-- Name: elements sy_nm_uq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT sy_nm_uq UNIQUE (symbol, name);
...
--
-- Name: properties at_n_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT at_n_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
